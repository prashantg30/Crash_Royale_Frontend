...
const AutoCashoutMobile = ({
  ...
  // useEffect ka istemal kar ke initial value set karte hain
  useEffect(() => {
  ...
  return (
    ...
    >
      <div className="">
        ...
        >
          <div className="bet-btn-content-mobile">
            <button
              className="btn-tab"
            ...
            <button
              className="btn-tab"
              onClick={() => handleMultiplierClick("2.00")}
              type="button"
              disabled={!autoCash}
            >
...
export default AutoCashoutMobile;