...
const CrashPointMobile = ({
    ...
    const decrementCalcValue = () => {
        setCalcValue((prevMulti) => {
            ...
            return `${Math.floor(newValue)}${Math.round((newValue % 1) * 100) > 0
    ...
    return (
        ...
        >
            <div className="" style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
                ...
                <div className="bet-btn-content-mobile" style={{ border: "1px solid rgb(60, 53, 83)", padding: "4px", borderRadius: "10px" }}>
                ...
                <div className="bet-btn-content-mobile" style={{ border: "1px solid rgb(60, 53, 83)", padding: "8px", borderRadius: "10px" }}>
                    <button
                        className="btn-tab"
                        style={{ cursor: disbaledButton ? "default" : "" }}
                        disabled={disbaledButton}
...
export default CrashPointMobile;
